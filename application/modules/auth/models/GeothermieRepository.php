...
/**
 * Class Auth_Model_GeothermieRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_GeothermieRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'GEO' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Geothermie();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Geothermie'] as $key => $val ) {
