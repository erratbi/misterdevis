 ...
 * User
 *
 * @Table(name="qualif_entretien_piscine")
 * @Entity(repositoryClass="Auth_Model_EntretienPiscineRepository")
 */
class Auth_Model_EntretienPiscine {

  /**
   * @var integer $id_qualif_entretien_piscine
   *
   * @Column(name="ID_QUALIF_ENTRETIEN_PISCINE", type="integer", nullable=false)
   * @Id
   * @GeneratedValue(strategy="IDENTITY")
   */
  private $id_qualif_entretien_piscine;
  ...
  /**
   * @return the $id_qualif_entretien_piscine
   */
  public function getId_qualif_entretien_piscine() {

    return $this->id_qualif_entretien_piscine;
  }
  ...
  /**
   * @param integer $id_qualif_entretien_piscine
   */
  public function setId_qualif_entretien_piscine($id_qualif_entretien_piscine) {

    $this->id_qualif_entretien_piscine = $id_qualif_entretien_piscine;
  }
