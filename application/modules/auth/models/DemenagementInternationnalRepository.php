...
/**
 * Class Auth_Model_DemenagementInternationnalRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_DemenagementInternationnalRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'DIN' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_DemenagementInternationnal();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['DemenagementInternationnal'] as $key => $val ) {
