...
/**
 * Class Auth_Model_TraitementHumiditeRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_TraitementHumiditeRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_TraitementHumidite|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_TraitementHumiditeRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'TCH' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_TraitementHumidite();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['TraitementHumidite'] as $key => $val ) {
