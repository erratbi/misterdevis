...
/**
 * Class Auth_Model_ElectriciteRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_ElectriciteRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'ELC' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Electricite();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Electricite'] as $key => $val ) {
