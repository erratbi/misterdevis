 ...
 * User
 *
 * @Table(name="qualif_demenagement_entreprise")
 * @Entity(repositoryClass="Auth_Model_DemenagementEntrepriseRepository")
 */
class Auth_Model_DemenagementEntreprise {
  
  /**
   * @var integer $id_qualif_demenagement_entreprise
   *
   * @Column(name="ID_QUALIF_DEMENAGEMENT_ENTREPRISE", type="integer", nullable=false)
   * @Id
   * @GeneratedValue(strategy="IDENTITY")
   */
  private $id_qualif_demenagement_entreprise;
   ...
   * @return int
   */
  public function getId_qualif_demenagement_entreprise() {
    
    return $this->id_qualif_demenagement_entreprise;
  }
  
  /**
   * @param int $id_qualif_demenagement_entreprise
   */
  public function setId_qualif_demenagement_entreprise( $id_qualif_demenagement_entreprise ) {
    
    $this->id_qualif_demenagement_entreprise = $id_qualif_demenagement_entreprise;
  }
