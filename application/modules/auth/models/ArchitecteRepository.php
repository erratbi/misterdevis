...
/**
 * Class Auth_Model_ArchitecteRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_ArchitecteRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'ARC' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Architecte();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Architecte'] as $key => $val ) {
