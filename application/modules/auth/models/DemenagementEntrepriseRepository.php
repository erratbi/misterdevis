...
/**
 * Class Auth_Model_DemenagementEntrepriseRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_DemenagementEntrepriseRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'DEN' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_DemenagementEntreprise();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['DemenagementEntreprise'] as $key => $val ) {
