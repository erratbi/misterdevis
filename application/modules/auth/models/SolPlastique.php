 ...
 * User
 *
 * @Table(name="qualif_sol_plastique")
 * @Entity(repositoryClass="Auth_Model_SolPlastiqueRepository")
 */
class Auth_Model_SolPlastique {
  
  /**
   * @var integer $id_qualif_sol_plastique
   *
   * @Column(name="ID_QUALIF_SOL_PLASTIQUE", type="integer", nullable=false)
   * @Id
   * @GeneratedValue(strategy="IDENTITY")
   */
  private $id_qualif_sol_plastique;
   ...
   * @return int
   */
  public function getId_qualif_sol_plastique() {
    
    return $this->id_qualif_sol_plastique;
  }
  
  /**
   * @param int $id_qualif_sol_plastique
   */
  public function setId_qualif_sol_plastique( $id_qualif_sol_plastique ) {
    
    $this->id_qualif_sol_plastique = $id_qualif_sol_plastique;
  }
