...
/**
 * Class Auth_Model_TraitementCharpenteRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_TraitementCharpenteRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_TraitementCharpente|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_TraitementCharpenteRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'TRC' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_TraitementCharpente();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['TraitementCharpente'] as $key => $val ) {
