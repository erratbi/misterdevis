...
class Auth_Model_DemandedevisProxy extends \Auth_Model_Demandedevis implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setType_travaux($type_travaux);
    }
    ...
    {
        return array('__isInitialized__', 'id_demande', 'titre_demande', 'delai_souhaite', 'description', 'type_demandeur', 'type_propriete', 'type_batiment', 'budget_approximatif', 'financement_projet', 'objectif_demande', 'prestation_souhaite', 'type_travaux', 'indication_complementaire', 'qualification', 'prix_mise_en_ligne', 'prix_promo', 'publier_en_ligne', 'publier_envoi', 'audio', 'date_creation', 'date_publication', 'id_particulier', 'id_activite', 'id_chantier', 'id_user', 'vendu', 'acheteurs');
    }
