...
/**
 * Class Auth_Model_VideoSurveillanceRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_VideoSurveillanceRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_VideoSurveillance|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_VideoSurveillanceRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'VDS' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_VideoSurveillance();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['VideoSurveillance'] as $key => $val ) {
