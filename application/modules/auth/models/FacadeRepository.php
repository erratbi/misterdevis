...
/**
 * Class Auth_Model_FacadeRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_FacadeRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_Facade|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_FacadeRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'FAC' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Facade();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Facade'] as $key => $val ) {
