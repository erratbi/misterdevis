 ...
 * User
 *
 * @Table(name="qualif_demenagement_famille")
 * @Entity(repositoryClass="Auth_Model_DemenagementFamilleRepository")
 */
class Auth_Model_DemenagementFamille {
  
  /**
   * @var integer $id_qualif_demenagement_famille
   *
   * @Column(name="ID_QUALIF_DEMENAGEMENT_FAMILLE", type="integer", nullable=false)
   * @Id
   * @GeneratedValue(strategy="IDENTITY")
   */
  private $id_qualif_demenagement_famille;
   ...
   * @return int
   */
  public function getId_qualif_demenagement_famille() {
    
    return $this->id_qualif_demenagement_famille;
  }
  
  /**
   * @param int $id_qualif_demenagement_famille
   */
  public function setId_qualif_demenagement_famille( $id_qualif_demenagement_famille ) {
    
    $this->id_qualif_demenagement_famille = $id_qualif_demenagement_famille;
  }
