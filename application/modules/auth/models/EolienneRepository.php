...
/**
 * Class Auth_Model_EolienneRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_EolienneRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_Eolienne|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_EolienneRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'EOL' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Eolienne();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Eolienne'] as $key => $val ) {
