...
/**
 * Class Auth_Model_ConstructionRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_ConstructionRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_Construction|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_ConstructionRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'CON' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Construction();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Construction'] as $key => $val ) {
