...
/**
 * Class Auth_Model_VisiophoneRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_VisiophoneRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_Visiophone|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_VisiophoneRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'VIS' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Visiophone();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Visiophone'] as $key => $val ) {
