...
/**
 * Class Auth_Model_MenuiserieRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_MenuiserieRepository extends EntityRepository {
   ...
   * @param      $data
   *
   * @return \Auth_Model_Menuiserie|null|object
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_MenuiserieRepository $qualification
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'MIN' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_Menuiserie();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['Menuiserie'] as $key => $val ) {
