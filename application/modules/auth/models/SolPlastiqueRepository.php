...
/**
 * Class Auth_Model_SolPlastiqueRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_SolPlastiqueRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'SOP' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_SolPlastique();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['SolPlastique'] as $key => $val ) {
