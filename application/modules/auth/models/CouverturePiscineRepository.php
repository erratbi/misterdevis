...
/**
 * Class Auth_Model_CouverturePiscineRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_CouverturePiscineRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'COP' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_CouverturePiscine();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['CouverturePiscine'] as $key => $val ) {
