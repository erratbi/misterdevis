...
/**
 * Class Auth_Model_DemenagementFamilleRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_DemenagementFamilleRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
    ...
    if ( ! $demande ) {
      ...
      $activite = $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'ref' => 'DEM' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_DemenagementFamille();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['DemenagementFamille'] as $key => $val ) {
