...
/**
 * Class Auth_EolienneController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité eolienne,
 * il permet de lister les demande de devis concernant la eolienne avec l'action indexAction,
 ...
 */
class Auth_EolienneController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'EOL';
  private $slug       = 'eolienne';
  private $name       = 'Eolienne';
  private $form_name  = 'Auth_Form_Eolienne';
  private $model_name = 'Auth_Model_Eolienne';
