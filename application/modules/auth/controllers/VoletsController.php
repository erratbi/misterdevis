...
/**
 * Class Auth_VoletsController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité volets,
 * il permet de lister les demande de devis concernant le volets avec l'action indexAction,
 ...
 */
class Auth_VoletsController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'VOL';
  private $slug       = 'volets';
  private $name       = 'Volets';
  private $form_name  = 'Auth_Form_Volets';
  private $model_name = 'Auth_Model_Volets';
