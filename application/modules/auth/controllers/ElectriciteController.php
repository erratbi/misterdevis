...
/**
 * Class Auth_ElectriciteController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité electricite,
 * il permet de lister les demande de devis concernant le electricite avec l'action indexAction,
 ...
 */
class Auth_ElectriciteController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ELC';
  private $slug       = 'electricite';
  private $name       = 'Electricite';
  private $form_name  = 'Auth_Form_Electricite';
  private $model_name = 'Auth_Model_Electricite';
