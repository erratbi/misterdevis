...
/**
 * Class Auth_TraitementCharpenteController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité traitement charpente,
 * il permet de lister les demande de devis concernant la traitement charpente avec l'action indexAction,
 ...
 */
class Auth_TraitementCharpenteController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'TRC';
  private $slug       = 'traitement-charpente';
  private $name       = 'TraitementCharpente';
  private $form_name  = 'Auth_Form_TraitementCharpente';
  private $model_name = 'Auth_Model_TraitementCharpente';
