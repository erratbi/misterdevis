...
/**
 * Class Auth_AlarmeIncendieController
 *
 ...
 */
class Auth_AlarmeIncendieController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ALI';
  private $slug       = 'alarme-incendie';
  private $name       = 'AlarmeIncendie';
  private $form_name  = 'Auth_Form_AlarmeIncendie';
  private $model_name = 'Auth_Model_AlarmeIncendie';
