...
/**
 * Class Auth_DemenagementFamilleController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité demenagement-famille,
 * il permet de lister les demande de devis concernant le demenagement-famille avec l'action indexAction,
 ...
 */
class Auth_DemenagementFamilleController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'DEM';
  private $slug       = 'demenagement-famille';
  private $name       = 'DemenagementFamille';
  private $form_name  = 'Auth_Form_DemenagementFamille';
  private $model_name = 'Auth_Model_DemenagementFamille';
