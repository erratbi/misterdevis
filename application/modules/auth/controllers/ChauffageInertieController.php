...
/**
 * Class Auth_ChauffageInertieController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité chauffe-eau,
 * il permet de lister les demande de devis concernant le chauffe-eau avec l'action indexAction,
 ...
 */
class Auth_ChauffageInertieController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'CHI';
  private $slug       = 'chauffage-inertie';
  private $name       = 'ChauffageInertie';
  private $form_name  = 'Auth_Form_ChauffageInertie';
  private $model_name = 'Auth_Model_ChauffageInertie';
