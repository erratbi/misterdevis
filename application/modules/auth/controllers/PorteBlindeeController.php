...
/**
 * Class Auth_PorteBlindeeController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité porte-entree,
 * il permet de lister les demande de devis concernant le porte-entree avec l'action indexAction,
 ...
 */
class Auth_PorteBlindeeController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'POB';
  private $slug       = 'porte-blindee';
  private $name       = 'PorteBlindee';
  private $form_name  = 'Auth_Form_PorteBlindee';
  private $model_name = 'Auth_Model_PorteBlindee';
