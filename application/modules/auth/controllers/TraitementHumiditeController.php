...
/**
 * Class Auth_TraitementHumiditeController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité traitement-humidite,
 * il permet de lister les demande de devis concernant la traitement-humidite avec l'action indexAction,
 ...
 */
class Auth_TraitementHumiditeController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'TCH';
  private $slug       = 'traitement-humidite';
  private $name       = 'TraitementHumidite';
  private $form_name  = 'Auth_Form_TraitementHumidite';
  private $model_name = 'Auth_Model_TraitementHumidite';
