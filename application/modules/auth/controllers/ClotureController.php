 ...
 */
class Auth_ClotureController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'CLO';
  private $slug       = 'cloture';
  private $name       = 'Cloture';
  private $form_name  = 'Auth_Form_Cloture';
  private $model_name = 'Auth_Model_Cloture';
