...
/**
 * Class Auth_CharpenteController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité charpente,
 * il permet de lister les demande de devis concernant le charpente avec l'action indexAction,
 ...
 */
class Auth_CharpenteController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'CHP';
  private $slug       = 'charpente';
  private $name       = 'Charpente';
  private $form_name  = 'Auth_Form_Charpente';
  private $model_name = 'Auth_Model_Charpente';
