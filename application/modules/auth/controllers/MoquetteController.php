...
/**
 * Class Auth_MoquetteController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité moquette,
 * il permet de lister les demande de devis concernant le moquette avec l'action indexAction,
 ...
 */
class Auth_MoquetteController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'MOQ';
  private $slug       = 'moquette';
  private $name       = 'Moquette';
  private $form_name  = 'Auth_Form_Moquette';
  private $model_name = 'Auth_Model_Moquette';
