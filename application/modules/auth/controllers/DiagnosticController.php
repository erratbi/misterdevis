...
/**
 * Class Auth_DiagnosticController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité diagnostic,
 * il permet de lister les demande de devis concernant le diagnostic avec l'action indexAction,
 ...
 */
class Auth_DiagnosticController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'VOL';
  private $slug       = 'diagnostic';
  private $name       = 'Diagnostic';
  private $form_name  = 'Auth_Form_Diagnostic';
  private $model_name = 'Auth_Model_Diagnostic';
