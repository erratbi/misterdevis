...
/**
 * Class Auth_DomotiqueController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité domotique,
 * il permet de lister les demande de devis concernant le domotique avec l'action indexAction,
 ...
 */
class Auth_DomotiqueController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'DOM';
  private $slug       = 'domotique';
  private $name       = 'Domotique';
  private $form_name  = 'Auth_Form_Domotique';
  private $model_name = 'Auth_Model_Domotique';
