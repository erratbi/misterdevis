...
/**
 * Class Auth_VideoSurveillanceController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité video-surveillance,
 * il permet de lister les demande de devis concernant la video-surveillance avec l'action indexAction,
 ...
 */
class Auth_VideoSurveillanceController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'VDS';
  private $slug       = 'video-surveillance';
  private $name       = 'VideoSurveillance';
  private $form_name  = 'Auth_Form_VideoSurveillance';
  private $model_name = 'Auth_Model_VideoSurveillance';
