...
/**
 * Class Auth_MenuiserieController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité menuiserie,
 * il permet de lister les demande de devis concernant la menuiserie avec l'action indexAction,
 ...
 */
class Auth_MenuiserieController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'MIN';
  private $slug       = 'menuiserie';
  private $name       = 'Menuiserie';
  private $form_name  = 'Auth_Form_Menuiserie';
  private $model_name = 'Auth_Model_Menuiserie';
