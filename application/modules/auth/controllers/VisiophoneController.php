...
/**
 * Class Auth_VisiophoneController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité visiophone,
 * il permet de lister les demande de devis concernant la visiophone avec l'action indexAction,
 ...
 */
class Auth_VisiophoneController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'VIS';
  private $slug       = 'visiophone';
  private $name       = 'Visiophone';
  private $form_name  = 'Auth_Form_Visiophone';
  private $model_name = 'Auth_Model_Visiophone';
