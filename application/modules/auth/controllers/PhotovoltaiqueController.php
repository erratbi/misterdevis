...
/**
 * Class Auth_PhotovoltaiqueController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité photovoltaique,
 * il permet de lister les demande de devis concernant la photovoltaique avec l'action indexAction,
 ...
 */
class Auth_PhotovoltaiqueController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'PHO';
  private $slug       = 'photovoltaique';
  private $name       = 'Photovoltaique';
  private $form_name  = 'Auth_Form_Photovoltaique';
  private $model_name = 'Auth_Model_Photovoltaique';
