...
/**
 * Class Auth_StationEpurationController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité station-epuration,
 * il permet de lister les demande de devis concernant la station-epuration avec l'action indexAction,
 ...
 */
class Auth_StationEpurationController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'MSE';
  private $slug       = 'station-epuration';
  private $name       = 'StationEpuration';
  private $form_name  = 'Auth_Form_StationEpuration';
  private $model_name = 'Auth_Model_StationEpuration';
