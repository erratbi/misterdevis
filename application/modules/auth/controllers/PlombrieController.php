...
/**
 * Class Auth_PlombrieController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité plombrie,
 * il permet de lister les demande de devis concernant le plombrie avec l'action indexAction,
 ...
 */
class Auth_PlombrieController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'PLO';
  private $slug       = 'plombrie';
  private $name       = 'Plombrie';
  private $form_name  = 'Auth_Form_Plombrie';
  private $model_name = 'Auth_Model_Plombrie';
