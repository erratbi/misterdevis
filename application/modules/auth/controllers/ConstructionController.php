...
/**
 * Class Auth_ConstructionController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité construction,
 * il permet de lister les demande de devis concernant la construction avec l'action indexAction,
 ...
 */
class Auth_ConstructionController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'CON';
  private $slug       = 'construction';
  private $name       = 'Construction';
  private $form_name  = 'Auth_Form_Construction';
  private $model_name = 'Auth_Model_Construction';
