...
/**
 * Class Auth_DemenagementEntrepriseController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité demenagement-entreprise,
 * il permet de lister les demande de devis concernant le demenagement-entreprise avec l'action indexAction,
 ...
 */
class Auth_DemenagementEntrepriseController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'DEN';
  private $slug       = 'demenagement-entreprise';
  private $name       = 'DemenagementEntreprise';
  private $form_name  = 'Auth_Form_DemenagementEntreprise';
  private $model_name = 'Auth_Model_DemenagementEntreprise';
