...
/**
 * Class Auth_InterphoneController
 *
 ...
 */
class Auth_InterphoneController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'INP';
  private $slug       = 'interphone';
  private $name       = 'Interphone';
  private $model_name = 'Auth_Model_Interphone';
