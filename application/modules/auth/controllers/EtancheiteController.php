...
/**
 * Class Auth_EtancheiteController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité etancheite,
 * il permet de lister les demande de devis concernant la etancheite avec l'action indexAction,
 ...
 */
class Auth_EtancheiteController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ETA';
  private $slug       = 'etancheite';
  private $name       = 'Etancheite';
  private $form_name  = 'Auth_Form_Etancheite';
  private $model_name = 'Auth_Model_Etancheite';
