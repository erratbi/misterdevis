...
/**
 * Class Auth_Abri_PortailController
 *
 ...
 */
class Auth_PortailController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'POR';
  private $slug       = 'portail';
  private $name       = 'Portail';
  private $form_name  = 'Auth_Form_Portail';
  private $model_name = 'Auth_Model_Portail';
