...
/**
 * Class Auth_DemenagementInternationnalController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité demenagement-internationnal,
 * il permet de lister les demande de devis concernant le demenagement-internationnal avec l'action indexAction,
 ...
 */
class Auth_DemenagementInternationnalController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'DIN';
  private $slug       = 'demenagement-internationnal';
  private $name       = 'DemenagementInternationnal';
  private $form_name  = 'Auth_Form_DemenagementInternationnal';
  private $model_name = 'Auth_Model_DemenagementInternationnal';
