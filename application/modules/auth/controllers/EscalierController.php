 ...
 */
class Auth_EscalierController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ESC';
  private $slug       = 'escalier';
  private $name       = 'Escalier';
  private $form_name  = 'Auth_Form_Escalier';
  private $model_name = 'Auth_Model_Escalier';
