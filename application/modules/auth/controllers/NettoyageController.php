...
/**
 * Class Auth_NettoyageController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité nettoyage,
 * il permet de lister les demande de devis concernant le nettoyage avec l'action indexAction,
 ...
 */
class Auth_NettoyageController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'NET';
  private $slug       = 'nettoyage';
  private $name       = 'Nettoyage';
  private $form_name  = 'Auth_Form_Nettoyage';
  private $model_name = 'Auth_Model_Nettoyage';
