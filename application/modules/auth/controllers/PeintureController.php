...
/**
 * Class Auth_PeintureController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité peinture,
 * il permet de lister les demande de devis concernant le peinture avec l'action indexAction,
 ...
 */
class Auth_PeintureController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'PEI';
  private $slug       = 'peinture';
  private $name       = 'Peinture';
  private $form_name  = 'Auth_Form_Peinture';
  private $model_name = 'Auth_Model_Peinture';
