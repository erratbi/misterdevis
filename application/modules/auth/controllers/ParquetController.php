 ...
 */
class Auth_ParquetController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'PAR';
  private $slug       = 'parquet';
  private $name       = 'Parquet';
  private $form_name  = 'Auth_Form_Parquet';
  private $model_name = 'Auth_Model_Parquet';
