...
/**
 * Class Auth_FacadeController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité façade,
 * il permet de lister les demande de devis concernant la façade avec l'action indexAction,
 ...
 */
class Auth_FacadeController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'FAC';
  private $slug       = 'facade';
  private $name       = 'Facade';
  private $form_name  = 'Auth_Form_Facade';
  private $model_name = 'Auth_Model_Facade';
