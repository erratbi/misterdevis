...
/**
 * Class Auth_ArchitecteController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité architecte,
 * il permet de lister les demande de devis concernant le architecte avec l'action indexAction,
 ...
 */
class Auth_ArchitecteController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ARC';
  private $slug       = 'architecte';
  private $name       = 'Architecte';
  private $form_name  = 'Auth_Form_Architecte';
  private $model_name = 'Auth_Model_Architecte';
